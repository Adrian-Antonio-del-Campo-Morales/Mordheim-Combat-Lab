...
from mordheim_combat_lab.core.models import Characteristics, FighterBuild
...
def test_no_scope_yes_rules_remain_without_an_implementation_family():
    ...
    assert implemented["summary"] == {"families": 70, "rules": 106, "kinds": {"compiler": 45, "mechanic": 20, "trait": 5}}
