"""Versioned Excel persistence for typed UI configuration and duel results."""
...
from ..core.models import Characteristics, DuelResult, FighterBuild
from .services import DuelExecutionSettings
